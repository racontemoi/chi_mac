...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
	...
	<body id="navigation">
		<ul>
			<li class="first" id="navigation[Start]"><a href="index.php?language=<?php echo $language; ?>" target="contentFrame">Avvia</a></li>
			...
			<?php endif ?>
				<li id="navigation[phpMyAdmin]"><a href="../phpmyadmin.php?lang=it-iso-8859-1&amp;language=<?php echo $language; ?>" target="contentFrame">phpMyAdmin</a></li>
