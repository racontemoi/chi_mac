...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de">
	...
	<body id="navigation">
		<ul>
			<li class="first" id="navigation[Start]"><a href="index.php?language=<?php echo $language; ?>" target="contentFrame">Start</a></li>
			...
			<?php endif ?>
				<li id="navigation[phpMyAdmin]"><a href="../phpmyadmin.php?lang=de-iso-8859-1&amp;language=<?php echo $language; ?>" target="contentFrame">phpMyAdmin</a></li>
			...
			<li class="last"><a href="http://www.mamp.info/de/mamp-pro/index.html" target="_blank">MAMP PRO testen</a></li>
		</ul>
