...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru">
	...
	<body id="navigation">
		<ul>
			<li class="first" id="navigation[Start]"><a href="index.php?language=<?php echo $language; ?>" target="contentFrame">Главная</a></li>
			...
			<?php endif ?>
				<li id="navigation[phpMyAdmin]"><a href="../phpmyadmin.php?lang=ru-utf-8&amp;language=<?php echo $language; ?>" target="contentFrame">phpMyAdmin</a></li>
